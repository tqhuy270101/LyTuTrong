...
<body>
    ...
    <div class="container-fluid" align="center">
        ...
        <div class="container">
            <div class="row justify-content-center form-tracuudiem">
                <form class="form-inline form-control" method="post">
                    {{ csrf_field() }}
                    <label class="col-3 col-form-label"><b>Họ tên:</b></label>
                    <div class="col-4">
                        <select class="form-control" style="width:250px" name="id_hs">
                            @foreach($hocsinh as $hs)
                            <option value="{{$hs->id_hocsinh}}">{{$hs->hoten}}</option>
                            @endforeach
                        </select>
                    </div>
                    <button class="col-2 btn btn-primary" type="submit">Tra cứu</button>
                </form>
            </div>
        </div>
