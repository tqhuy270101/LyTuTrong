...
<div class="col-md-10">
		            	...
		            	<div class="row justify-content-around alert alert-success">
		            		<div class="col-4">
								@foreach($tkb_ngay_chieu as $ngay)
									<h5>Áp dụng từ ngày: {{ date('d-m-Y', strtotime($ngay->ngayapdung)) }}</h5>
								@endforeach
		            			<div class="form-inline">
		            				<a href="{{ URL::to('/thongbao/thoikhoabieu/hocsinh/lop8A/sang') }}" class="form-control button-tkb">Buổi sáng</a>
		            				<a href="{{ URL::to('/thongbao/thoikhoabieu/hocsinh/lop8A') }}" class="form-control button-tkb">Buổi chiều</a>
		            			</div>
		            		</div>
							<div class="text-title-tkb">
								<h5>Buổi sáng</h5>
