		            	...
		            	<div class="row justify-content-around alert alert-success">
		            		<div class="col-4">
		            			...
		            			<div class="form-inline">
		            				<a href="{{ URL::to('/thongbao/thoikhoabieu/hocsinh/lop9B/sang') }}" class="form-control button-tkb">Buổi sáng</a>
		            				<a href="{{ URL::to('/thongbao/thoikhoabieu/hocsinh/lop9B') }}" class="form-control button-tkb">Buổi chiều</a>
		            			</div>
		            		</div>
							<div class="text-title-tkb">
								<h5>Buổi sáng</h5>
